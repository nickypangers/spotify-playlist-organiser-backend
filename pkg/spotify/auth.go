...
func GetSpotifyAccessToken(grantType, code string) (models.AccessTokenResponse, bool) {
...
func GetRefreshedAccessToken(refreshToken string) (models.AccessTokenResponse, bool) {
	authHeader := getAuthHeader("Basic")
